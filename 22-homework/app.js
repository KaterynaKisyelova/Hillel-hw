...
const FORM_CONTAINER_SELECTOR = "#stickers-form";
...
const form = new StickersFormModal({
  onSubmit: (sticker) => addNewSticker(sticker),
});

form.appendTo($(FORM_CONTAINER_SELECTOR));
